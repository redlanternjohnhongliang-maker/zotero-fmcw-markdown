...
|---|---|---|
| continue_weak_weighting | NO-GO | conditional_switch_to_rdra_smoke_followup |
| switch_to_rdra | CONDITIONAL-SMOKE | conditional_switch_to_rdra_smoke_followup |
| enter_D6 | NO-GO | conditional_switch_to_rdra_smoke_followup |
