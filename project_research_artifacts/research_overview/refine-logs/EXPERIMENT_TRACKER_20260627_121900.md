...
| R008 | D5 | weak-target loss | weak-target-weighted detection loss | train/val/test | weak Pd@PFA, miss, FAR | DONE | D5 通过；best=`weak_peak_w2p0`，medium/default/PFA=1e-2 下 weak Pd=0.3855，略高于 D4 `balanced_mild`=0.3817；false alarm 149 vs 150，mid/strong Pd 未降，clean no-harm 正常；可进入 D6 但需验证提升不是靠 false alarm 或 peak inflation |
