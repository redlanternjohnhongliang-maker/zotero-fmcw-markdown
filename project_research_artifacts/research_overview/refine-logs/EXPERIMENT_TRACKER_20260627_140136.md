...
| R009 | D6 | false alarm control | weak-target loss + FA penalty | train/val/test | weak Pd@PFA, FAR | TODO | HOLD：D5-diagnosis 不建议启动；需先修 weak target 定义或升级 RD/RA 表示，再决定是否重新进入 D6 |
