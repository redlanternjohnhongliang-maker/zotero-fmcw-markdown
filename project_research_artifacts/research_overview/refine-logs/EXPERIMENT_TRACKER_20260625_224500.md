...
|---|---|---|---|---|---|---|---|
| R001 | D1 | 数据与 mask sanity | no mitigation | train/val | weak/mid/strong counts, target/background mask | TODO | 必须确认背景 cell 定义 |
| R002 | D1 | CA-CFAR sanity | CA-CFAR + clean/interfered RD | val | cell-level PFA, Pd, FAR | TODO | validation threshold for PFA=1e-2/1e-3 |
| R003 | D1 | differentiable CA-CFAR sanity | diff-CA-CFAR layer | tiny batch | differentiable output, gradients | TODO | 确认可反传 |
